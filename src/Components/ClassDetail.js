...
const ClassDetail = (props) => {
  ...
  const class_data =[
    ...
    },
    {
      ...
      "class_details": "Debate topic: \nShould the US provide free college for eligible students\n\nDid you know that public speaking is the number one fear for most people? Yet it's a necessary skill in nearly every profession and a crucial part of life in general. \n\nIn this class, learners will overcome that fear by consistently practicing their public speaking and debate skills. \nThe class will start with a short lesson on the fundamentals of debate (logic, fallacy, etc).   These lessons will change weekly but learners will be able to participate in class even if they didn’t join from the start. \nThe second half of the class will be spent practicing beginner debate skills. Learners will be given the topic a week in advance so they can do some research and gather facts to support their opinion. \n\nThis class is to introduce learners to speech writing and debate and is an open debate style.  Leaners will all be given a chance to present their opening argument. Then we will go to the rebuttal round where they are encouraged to counter the opposition's arguments. A debate can't be won just by speaking, it's just as important to listen. We will encourage them to listen to the other side and think of ways to weaken their points.",
      "prerequisite": "There are no prerequisites needed for the class.",
      "learning_outcomes": "Our primary goal in this class is to build confidence and communication skills. Learners will also benefit from learning basic debate fundamentals, how to organize and express their thoughts, the importance of data and logic, crucial listening skills and how to disagree with others.",
      "about_teacher": "Bill has coached and instructed speech and debate for more than 30 years with a variety of University, high school, & middle school programs around the country. In the last decade he has coached 7 high school national finalists and 11 middle school national finalists. He has coached 5 high school national champions and 3 middle school national champions in his career.  Bill received a B.A. in Speech Communication  from Western Kentucky University in 2002 and also competed in speech and debate at the collegiate level.",
      "teaching_philosophy": "In my classes I like to teach debaters the foundational components of debate while guiding their discovery of their unique voices.  It is my belief that debate allows students to critically explore the world around them and advocate for the policies and changes they would like to see in that world.",
    ...
    },
    {
      ...
      "class_details": "Let's take an adventure together!  What do you say?  Creative writing is just that!  An adventure.  In creative writing we can  get  inspiration from a variety of things:  scenery, a painting, a sound or even an emotion. \nIn this class, your  inspiration will come from pictures of  animals. \nUsing your imagination and creative ideas, the teacher will guide you through a piece of writing from brainstorming to a finished piece. \nThis class is interactive, engaging and fun!\nJoin us in your writing adventure !",
      "prerequisite": "There are no prerequisites needed for the class.",
      "learning_outcomes": "Learn to harness the power of visual inspiration from animal imagery to develop imaginative writing skills, from initial brainstorming to crafting a complete piece, in an interactive and enjoyable class environment",
      "about_teacher": "I graduated with QTS in 2015 and  have worked in schools mainly primary since, after having my own children in 2016 and onwards I found a passion in online teaching and tuition. I have broadened my horizons and now offer pre-K to ages 16 and thoroughly love the diversity of the different age ranges. \n",
      "teaching_philosophy": "I am a kind and patient teacher with the view that every child deserves to be able to succeed. I pride my abilities to adapt to different styles of teaching to suit the needs of the learner. Everyone learns in their unique way.\n",
    ...
    },
    {
      ...
      "class_details": "A introduction to logical reasoning and thinking using matrix logic and other fun puzzles",
      "prerequisite": "There are no prerequisites needed for the class.",
      "learning_outcomes": "Familiarizing students with logic through a gamified process",
      "about_teacher": "Alan earned his bachelor’s degree in mathematics and master’s degree in economics from Rutgers University, New Brunswick. Additionally, Alan is about to complete his Ph.D. in economics. Alan has taught various courses at Rutgers, TCNJ, and even Princeton, from statistics to American economic history to The Philosophical and Economic Roots of Inequality. He has also taught various math, statistics, and physics levels at many after-school extra-curricular programs.",
      "teaching_philosophy": "Alan’s classes are all about classroom engagement! Be prepared to talk, think and discuss like never before! Through a combination of games and other fun activities, Alan seeks to lead classes that will leave his students thinking, laughing, and learning.",
    ...
    },
    {
      ...
      "class_details": "Debate topic: Should the US provide free college for eligible students\n\nDid you know that public speaking is the number one fear for most people? Yet it's a necessary skill in nearly every profession and a crucial part of life in general. \n\nIn this class, learners will overcome that fear by consistently practicing their public speaking and debate skills. \nThe class will start with a short lesson on the fundamentals of debate (logic, fallacy, etc).   These lessons will change weekly but learners will be able to participate in class even if they didn’t join from the start. \nThe second half of the class will be spent practicing beginner debate skills. Learners will be given the topic a week in advance so they can do some research and gather facts to support their opinion. \n\nThis class is to introduce learners to speech writing and debate and is an open debate style.  Leaners will all be given a chance to present their opening argument. Then we will go to the rebuttal round where they are encouraged to counter the opposition's arguments. A debate can't be won just by speaking, it's just as important to listen. We will encourage them to listen to the other side and think of ways to weaken their points.",
      "prerequisite": "There are no prerequisites needed for the class.",
      "learning_outcomes": "Our primary goal in this class is to build confidence and communication skills. Learners will also benefit from learning basic debate fundamentals, how to organize and express their thoughts, the importance of data and logic, crucial listening skills and how to disagree with others.",
      "about_teacher": "Bill has coached and instructed speech and debate for more than 30 years with a variety of University, high school, & middle school programs around the country. In the last decade he has coached 7 high school national finalists and 11 middle school national finalists. He has coached 5 high school national champions and 3 middle school national champions in his career.  Bill received a B.A. in Speech Communication  from Western Kentucky University in 2002 and also competed in speech and debate at the collegiate level.",
      "teaching_philosophy": "In my classes I like to teach debaters the foundational components of debate while guiding their discovery of their unique voices.  It is my belief that debate allows students to critically explore the world around them and advocate for the policies and changes they would like to see in that world.",
    ...
    },
    {
      ...
      "class_details": "An introduction to formal logic and predicate calculus where students are introduced to propositional phrases and truth tables.",
      "prerequisite": "There are no prerequisites needed for the class.",
      "learning_outcomes": "Familiarize students with the foundations of formal logic that is used in philosophy, mathematics, computer science and linguistics.",
      "about_teacher": "Alan earned his bachelor’s degree in mathematics and master’s degree in economics from Rutgers University, New Brunswick. Additionally, Alan is about to complete his Ph.D. in economics. Alan has taught various courses at Rutgers, TCNJ, and even Princeton, from statistics to American economic history to The Philosophical and Economic Roots of Inequality. He has also taught various math, statistics, and physics levels at many after-school extra-curricular programs.",
      "teaching_philosophy": "Alan’s classes are all about classroom engagement! Be prepared to talk, think and discuss like never before! Through a combination of games and other fun activities, Alan seeks to lead classes that will leave his students thinking, laughing, and learning.",
      "teacher_pic": "https://imgur.com/gH00FxU.png",
